...
#files <- list.files(path=datapath,pattern="22H1*",full.names = T)
files <- "/dmidata/projects/nckf/earthshine/Infrasound/I22FR//22H1_BDF_1727999.txt"
...
for (infilename in files)
{
  ...
  # plot
  plot(df$posix_time,df$signal,pch=19,cex=0.1,xlab="Date",ylab='Sensor signal',main=infilename, 
       xlim=c(as.POSIXct("2022-01-15 06:30:00 UTC"), as.POSIXct("2022-01-15 07:00:00 UTC")))
  print(c(nrow(df),infilename))
}
```
