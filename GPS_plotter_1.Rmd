...
#system("scp -i ~/.ssh/id_rsa pth@furthur.home:~/gps_data.txt DATA/")
=======
>>>>>>> d558d9bbf954c9081ae1c7e0666af7bf31247af1
```
...
plot(hour(df$POSIX_UTC)+minute(df$POSIX_UTC)/60,easting_northing[,1]-mean(easting_northing[,1]),pch=19,cex=0.1,ylab='Easting anomaly [m]')
plot(hour(df$POSIX_UTC)+minute(df$POSIX_UTC)/60,easting_northing[,2]-mean(easting_northing[,2]),pch=19,cex=0.1,ylab='Northing anomaly [m]')
```
