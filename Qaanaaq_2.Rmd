...
# plots
```{r}
plot(df$POSIX,df$speed,pch=19,cex=0.1,main="OMB bouy at Qaanaaq 2024",ylab="speed [m/s]",log="y")
points(df$POSIX[idx],df$speed[idx],pch=19,cex=0.1,col=day(df$POSIX))
uv_ran <- c(-2.5,1)
plot(df$POSIX,df$u,pch=19,cex=0.1,main="OMB bouy at Qaanaaq 2024",ylab="abs u-speed [m/s]",ylim=uv_ran)
points(df$POSIX[idx],df$u[idx],pch=19,cex=0.1,col=day(df$POSIX))
plot(df$POSIX,df$v,pch=19,cex=0.1,main="OMB bouy at Qaanaaq 2024",ylab="abs v-speed [m/s]",ylim=uv_ran)
points(df$POSIX[idx],df$v[idx],pch=19,cex=0.1,col=day(df$POSIX))
#
plot(df$u[idx],df$v[idx],pch=19,cex=0.6,main="OMB bouy at Qaanaaq 2024",ylab="v-speed [m/s]",col=hour(df$POSIX[idx]),xlab="u-speed [m/s]",asp=1,xlim=c(-1,1),ylim=c(-1,1))
abline(h=0)
abline(v=0)
