---
title: "Trilaterating calving sounds"
output: 
  pdf_document: 
    fig_height: 7
    fig_caption: yes
...
Trilateration for the calving-related Qaanaaq data. L-BFGS-B is able to solve the x,y location of the source.
...
#setwd("/data/users/pth/WORKSHOP/QAANAAQ/")
library(nleqslv)
library(sp)
library(lubridate) 
library(oce)
