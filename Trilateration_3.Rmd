...
<<<<<<< HEAD
    return(1e-5)  # Return 0 for parameters outside plausible range
=======
    ...
    return(1)
>>>>>>> 8a3420df679ac4890d73d1efadce377425eb256f
  }
  # Otherwise, return 1
  return(1)
}
...
n_burn <- 3000  # Number of burn-in iterations
initial_guess <- c(xx = 540, yy = 8400., zz = 70, t0 = 200)  # Initial guess
=======
...
post.samp <- MCMCmetrop1R(log_merit_function, y = y, X = X, mcmc = n_iter + n_burn, thin = 1, tune=.1, theta.init = initial_guess) 
