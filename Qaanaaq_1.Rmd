...
#
plot(df$easting,df$northings,asp=1)
```
...
test_signal <- sin(2*pi/test_period_in_hours*df$hours)*0.01
...
plot(ls_periodogram$scanned, ls_periodogram$power, type = 'l', xlab = 'Period [hours]', ylab = 'Power in speed', xlim=c(5.5,5.75),ylim=c(0,0.006),log="x")
abline(v=test_period_in_hours,col=2,lwd=1)
